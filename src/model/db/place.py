...
class Model(base):
    ...
    place_provider = pw.CharField(max_length=32, default="", index=True)
    provider_place_id = pw.CharField(max_length=128, default="", index=True)
    provider_rating = pw.FloatField(null=True)
    provider_user_ratings_total = pw.IntegerField(default=0)
    provider_rating_cached_at = pw.CharField(max_length=20, default="")
