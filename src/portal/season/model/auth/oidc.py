...
REDIRECT_URI = config.auth_oidc_redirect_uri
...
class OIDC:
    ...
    def __call__(self):
        ...
        if hasattr(self, action):
            ...
            if not REDIRECT_URI:
                raise ValueError("season.auth_oidc_redirect_uri must be configured")
            client.redirect_uris.append(REDIRECT_URI)
            client.registration_response["redirect_uris"] = [REDIRECT_URI]
